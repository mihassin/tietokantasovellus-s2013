<?php 
	...
	function getMaterials() {
        ...
        function getCartItemsByUid($uid) {
        	$querystr = "SELECT cart_map.id as id, products.name as name, cart_map.amount as kpl, cart_map.price as price, cart_map.added_mats as mats FROM products, cart_map WHERE products.id = cart_map.product_id AND cart_map.ordered = FALSE AND cart_map.user_id = {$uid} AND products.product_type_id='1';";
        	return $querystr;
        }
